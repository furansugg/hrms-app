...
export function Sidebar() {
  ...
  return (
    <>
      ...
      <button
        type="button"
        className="fixed top-4 left-4 z-50 md:hidden h-10 w-10 flex items-center justify-center rounded-md bg-slate-900 text-white shadow-lg"
      ...
      <aside
        className={cn(
          "fixed inset-y-0 left-0 z-40 w-64 flex flex-col bg-slate-900 text-slate-100 transition-transform duration-200 md:translate-x-0",
